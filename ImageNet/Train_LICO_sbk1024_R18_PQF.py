...
if __name__ == '__main__':
    ...
    parser.add_argument('--load_model_path', type=str,
                        default='save_model/R18/PQF_method/implementation/quantization_smallblocks_k1024_compressed_model.pt')
    parser.add_argument('--save_model_path', type=str,
                        default='save_model/R18/PQF_method/implementation/quantization_smallblocks_k1024_compressed_model_trained.pt')
