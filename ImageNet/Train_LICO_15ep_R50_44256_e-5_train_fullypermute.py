...
if __name__ == '__main__':
    ...
    parser.add_argument('--load_model_path', type=str,
                        default='save_model/R50/LRQ/quantization_4_4_k256_compressed_model_imagenet_nodf_fullypermute.pt')
    parser.add_argument('--save_model_path', type=str,
                        default='save_model/R50/LRQ/quantization_4_4_k256_compressed_model_imagenet_nodf_fullypermute_trained.pt')
