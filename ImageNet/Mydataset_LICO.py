...
Train_path = "Dataset/ILSVRC2012/DATA/Train"
Val_path = "Dataset/ILSVRC2012/DATA/Val"
...
def get_trainset(batch_size):
    ...
    train_dataloader = torch.utils.data.DataLoader(train_datasets, batch_size=batch_size, shuffle=True,num_workers=4,pin_memory=True)
...
def get_valset(batch_size):
    ...
    val_dataloader = torch.utils.data.DataLoader(val_datasets, batch_size=batch_size, shuffle=True, num_workers=4,pin_memory=True)
