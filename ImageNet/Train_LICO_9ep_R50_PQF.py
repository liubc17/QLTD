...
def train(args, logger):
    ...
    logger.logger.info('The best performence is:{:.3f}%'.format(max(test_acc_list) * 100))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--load_model_path', type=str,
                        default='save_model/R50/PQF_method/quantization_ls_k256_compressed_model_imagenet.pt')
    parser.add_argument('--save_model_path', type=str,
                        default='save_model/R50/PQF_method/quantization_ls_k256_compressed_model_imagenet_trained.pt')
