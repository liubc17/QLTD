...
from lr_scheduler_utils.LabelSmoothing import LSR
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_model_path', type=str,
                        default='save_model/R18/LRQ/quantization_2_4_k256_compressed_model_imagenet_df15_labelsmooth_trained.pt')
