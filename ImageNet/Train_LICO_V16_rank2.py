...
if __name__ == '__main__':
    ...
    parser.add_argument('--load_model_path', type=str,
                        default='save_model/VGG16/lowrank/lowrank_2_compressed_model_imagenet.pt')
    parser.add_argument('--save_model_path', type=str,
                        default='save_model/VGG16/lowrank/lowrank_2_compressed_model_imagenet_9ep_trained.pt')
