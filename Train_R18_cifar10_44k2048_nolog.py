...
if __name__ == '__main__':
    ...
    parser.add_argument('--load_model_path', type=str,
                        default='save_model/LRQ/parameters/centroids/quantization_4_4_k2048_compressed_model_cifar10.pt')
    parser.add_argument('--save_model_path', type=str,
                        default='save_model/LRQ/parameters/centroids/quantization_4_4_k2048_compressed_model_cifar10_trained.pt')
